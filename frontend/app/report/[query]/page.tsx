...
// Title = [商品名] 避坑报告_实测参数扒皮_是否智商税 | AI避坑导购
// ============================================
export async function generateMetadata({
  ...
  // 精简商品名：去除过长的冗余词（如 "怎么样 值得买吗 评价" 等口语后缀）
  ...
  const productName = cleanName || decoded;
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-10 border-b border-gray-100 bg-white/90 backdrop-blur-sm">
        <div className="mx-auto flex max-w-5xl items-center gap-4 px-4 py-3">
          ...
          <BookmarkButton
            ...
            reportPath={`/report/${encodeURIComponent(decodedQuery)}`}
          />
      ...
      <div className="mb-8">
        ...
        {/* 流式渲染组件（ErrorBoundary 包裹，防止异常导致白屏） */}
